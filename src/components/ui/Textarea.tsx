      ...
      <div className="w-full">
        <div className="relative">
          <textarea
            ...
            className={cn(
              'peer w-full resize-none rounded-lg border bg-slate-900/60 px-4 pb-2 pt-5 text-sm text-slate-100 outline-none transition-colors placeholder-transparent',
